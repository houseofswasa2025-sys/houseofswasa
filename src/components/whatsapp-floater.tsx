...
export function WhatsAppFloater({ number }: { number: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 sm:h-16 sm:w-16"
    >

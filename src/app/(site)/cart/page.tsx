  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="h-7 w-7 rounded-full border border-gold-light text-sm"
                  >
                    −
                  </button>
      ...
      <div className="mt-6 rounded-xl border border-gold-light/60 bg-white p-4">
        ...
        <Link
          href="/checkout"
          className="mt-4 block w-full rounded-full bg-maroon py-2.5 text-center text-sm font-semibold text-white hover:bg-maroon-dark"
        >
          Proceed to Checkout
        </Link>
      </div>

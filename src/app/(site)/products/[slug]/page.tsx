      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <a
            ...
            className="mt-3 flex w-full items-center justify-center gap-2 rounded-full border border-[#25D366] px-5 py-2.5 text-sm font-semibold text-[#128C4A] hover:bg-[#25D366]/10"
          >
            Order on WhatsApp
          </a>

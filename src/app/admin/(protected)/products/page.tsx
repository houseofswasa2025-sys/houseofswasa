                    ...
                    {p.colors.map((c) => (
                      <span
                        ...
                        className={`rounded-full px-2 py-0.5 text-[10px] font-medium ${
                          c.stock <= 0 ? "bg-red-50 text-red-600" : c.stock < 5 ? "bg-amber-50 text-amber-700" : "bg-ivory text-foreground/60"
                        }`}
                      >
                        {c.name}: {c.stock}
                      </span>
            ...
            <table className="w-full min-w-[760px] text-sm">
              <thead>
                <tr className="border-b border-gold-light/60 text-left text-xs uppercase tracking-wide text-foreground/50">
                  ...
                  <th className="p-3">Colors &amp; Stock</th>
                  ...
                  return (
                    <tr key={p.id} className="border-b border-gold-light/30 last:border-0">
                      ...
                      <td className="p-3">
                        ...
                        <p className={`mt-1 text-xs ${totalStock <= 0 ? "text-red-600" : "text-foreground/50"}`}>
                          Total: {totalStock}
                        </p>
                      </td>
                      <td className="p-3">
